                                ...
                                <div class="row" style="display: none;">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="discount_method" id="discount_method">
                                        </div>
                                    </div>
                                </div>
            ...
            <div id="order-discount" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                <div role="document" class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <select name="order_discount_type" id="order_discount_type" class="form-control">
                                    <option value="0">Select Discount Method</option>
...
$('select[name="order_discount_type"]').on("change",function(){
    ...
    $('#discount_method').val(discount_method);
});
...
function calculateGrandTotal() {
    ...
    if(discount_method == 2){
        ...
        var grand_total = (subtotal + order_tax + shipping_cost)-discount;
    }else{
