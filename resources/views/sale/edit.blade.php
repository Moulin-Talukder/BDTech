                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="commission_rate" id="commission_rate" value="{{$lims_sale_data->commission_rate}}" class="form-control" step="any" />
                                            <input type="hidden" name="commission_amount" id="commission_amount" value="{{$lims_sale_data->commission_amount}}" class="form-control" step="any" />
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
