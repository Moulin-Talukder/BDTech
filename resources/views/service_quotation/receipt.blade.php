...
<body>
    ...
    <div class="container print-container">
        ...
        <div class="navbar">
            ...
            <div class="image p1">
            <a href="{{url('/')}}"><img src="{{url('public/logo/logo.jpeg')}}" height="100" width="300" alt="image"></a>
            </div>
            ...
            <div>
                <h2 class="p3 sm-heading">
                    ...
                    <div class="semi-r2">
                        ...
                        <div class="p1">
                            @foreach($lims_services_quotation_data as $key=>$services_quotation)
                            <?php
                            $service_data = DB::table('services')->find($services_quotation->service_id);
                            ?>
                            <p>{{ \Carbon\Carbon::createFromTimestamp(strtotime($service_data->created_at))->format('d-m-Y')}}</p>
                            @break
                            @endforeach
                        </div>
                    ...
                    <div class="semi-r3">
                        ...
                        <div class="p1">
                            <p>{{ \Carbon\Carbon::createFromTimestamp(strtotime($lims_quotation_data->delivary_date))->format('d-m-Y')}}</p>
                        </div>
        ...
        <div class="row1 sm-heading">
            ...
            <div class="p1">
                <p>{{ $lims_customer_list->company_name}}</p>
            </div>
        ...
        <div class="row2 sm-heading">
            ...
            <div class="p1">
                <p>{{ $lims_customer_list->head_office_address }}</p>
            </div>
        ...
        <div class="row3 sm-heading">
            ...
            <div class="div1">
                ...
                <div class="p1">
                    <p>{{ $lims_quotation_data->bareer_name }}</p>
                </div>
            </div>
            ...
            <div class="div2">
                ...
                <div class="p1">
                    <p>{{ $lims_quotation_data->designation }}</p>
                </div>
            </div>
            ...
            <div class="div3">
                ...
                <div class="p1">
                    <p>{{ $lims_customer_list->phone_number }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="row5 sm-heading">
            ...
            <div class="div4">
                ...
                <div class="p1">
                    <p>{{ $lims_quotation_data->description }}</p>
                </div>
            </div>
        ...
        <div class="row6 sm-heading">
            ...
            <div class="div6">
                ...
                <div class="p1">
                    <p>{{ $lims_quotation_data->purpose }}</p>
                </div>
            </div>
