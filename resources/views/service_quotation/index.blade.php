@extends('layout.main') @section('content')
    ...
    <section>
        <div class="container-fluid">
            ...
            <a href="{{route('service_quotations.create')}}" class="btn btn-info">
                <em class="dripicons-plus"></em> {{trans('Add Service Receipt')}}</a>
            ...
            <table id="quotation-table" class="table quotation-list">
                ...
                @foreach($lims_quotation_all as $key=>$quotation)
                    ...
                    <tr class="quotation-link">
                        ...
                        @elseif($quotation->sale_status == 2)
                            <td>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                    ...
                                    <li>
                                        <button type="button" data-id="{{ $quotation->id }}"
                                                onclick="openModal({{$quotation->id}})"
                                    ...
                                    @if(in_array("quotes-edit", $all_permission))
                                        <li>
                                            <a class="btn btn-link"
                                               href="{{ route('service_quotations.edit', $quotation->id) }}"><i
                                    ...
                                    <li>
                                        <a class="btn btn-link"
                                           href="{{ route('service_quotations.receipt', $quotation->id) }}"><i
                                                class="dripicons-document"></i> {{trans('Receipt')}}</a></button>
                                    </li>
                                ...
                                <li>
                                    ...
                                    @if(in_array("quotes-delete", $all_permission))
                                        {{ Form::open(['route' => ['service_quotations.destroy', $quotation->id], 'method' => 'DELETE'] ) }}
                                        <li>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <form action="{{route('service.quotation.sale')}}" method="POST">
                            @csrf
                            <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        function openModal(id) {
            ...
            var url = "{{ route('service_quotations.services.sum', ":id") }}";
