                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                <li>
                                    <a href="{{ route('service.invoice',$sale->id) }}" class="btn btn-link"><i class="fa fa-copy"></i> Generate Invoice</a>
                                <li>

                                <li>
                                    <a href="{{ route('service.chalan',$sale->id) }}" class="btn btn-link"><i class="fa fa-copy"></i> Chalan</a>
                                </li>
