...
<div class="alert alert-danger alert-dismissible text-center">
    <button type="button" id="close" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>{{ session()->get('not_permitted') }}</div>
@endif
<section class="forms">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <select id="supplier" name="supplier_id" class=" sel form-control" data-live-search="true" data-live-search-style="begins" >
                                                    ...
                                                    <option
                                                        {{--@isset($purchaseModalcategory) @if($purchaseModalcategory==$supplier->id) selected--}}
                                                        {{--@endif@endisset --}}
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group mt-4">
                            <input type="submit" id="supplierAddButton" value="{{trans('file.submit')}}" class="btn btn-primary">
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <select name="category_id" required class="selectpicker form-control sel" data-live-search="true" data-live-search-style="begins" title="Select Category...">
                                    ...
                                    <option @isset($purchaseModalcategory) @if($purchaseModalcategory==$category->id) selected
                                        @endif
...
<script type="text/javascript">
    ...
    function populate_category(unitID){
        var url = "{{ route('product.unitId', ":id") }}";
