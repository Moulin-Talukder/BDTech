...
<section>
    <div class="table-responsive">
        <table id="delivery-table" class="table">
            ...
            <tbody>
                @foreach($service_delivery_list as $key => $delivery)
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                    ...
                                    <li class="divider"></li>
                                    {{ Form::open(['route' => ['service_delivery.destroy', $delivery->id], 'method' => 'post'] ) }}
                                    <li>
    ...
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                {!! Form::open(['route' => 'service_delivery.updateDelivey', 'method' => 'post', 'files' => true]) !!}
                <div class="row">
