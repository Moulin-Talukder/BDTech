...
@section('content')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name"
                                                   @isset($oldProduct['name']) value="{{$oldProduct['name']}}" @endisset
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="code" class="form-control" id="code"
                                                       ...
                                                       @isset($oldProduct['code']) value="{{$oldProduct['code']}}"
                                                       @endisset required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <select name="barcode_symbology" required
                                                    ...
                                                    <option
                                                        @isset($oldProduct['barcode_symbology']) @if($oldProduct['barcode_symbology'] == "C128") selected
                                                        @endif  @endisset value="C128">Code 128
                                                    </option>
                                                    <option
                                                        @isset($oldProduct['barcode_symbology']) @if($oldProduct['barcode_symbology'] == "C39") selected
                                                        @endif @endisset value="C39">Code 39
                                                    </option>
                                                    <option
                                                        @isset($oldProduct['barcode_symbology']) @if($oldProduct['barcode_symbology'] == "UPCA") selected
                                                        @endif @endisset value="UPCA">UPC-A
                                                    </option>
                                                    <option
                                                        @isset($oldProduct['barcode_symbology']) @if($oldProduct['barcode_symbology'] == "UPCE") selected
                                                        @endif @endisset value="UPCE">UPC-E
                                                    </option>
                                                    <option
                                                        @isset($oldProduct['barcode_symbology']) @if($oldProduct['barcode_symbology'] == "UPCE") selected
                                                        @endif @endisset value="UPCE">EAN-8
                                                    </option>
                                                    <option
                                                        @isset($oldProduct['barcode_symbology']) @if($oldProduct['barcode_symbology'] == "EAN13") selected
                                                        @endif @endisset value="EAN13">EAN-13
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                                    ...
                                                    <select required class="form-control selectpicker" name="unit_id">
                                                        ...
                                                        @foreach($lims_unit_list as $unit)
                                                            @if($unit->base_unit==null)
                                                                ...
                                                                <option
                                                                    @isset($oldProduct['unit_id'])
                                                                    @if($oldProduct['unit_id'] == $unit->id) selected
                                                                    @endif
                                                                    @endisset
                                                ...
                                                <div class="input-group">
                                                    <select class="form-control selectpicker" name="sale_unit_id">
                                                        ...
                                                        @foreach($lims_unit_list as $unit)
                                                            @if($unit->base_unit==null)
                                                                <option
                                                                    @isset($oldProduct['sale_unit_id'])
                                                                    @if($oldProduct['sale_unit_id'] == $unit->id) selected
                                                                    @endif
                                                                    @endisset
                                                                    value="{{$unit->id}}">{{$unit->unit_name}}</option>
                                                            @endif
                                                    ...
                                                    <div class="input-group">
                                                        <select class="form-control selectpicker"
                                                            ...
                                                            @foreach($lims_unit_list as $unit)
                                                                @if($unit->base_unit==null)
                                                                    <option
                                                                        @isset($oldProduct['purchase_unit_id'])
                                                                        @if($oldProduct['purchase_unit_id'] == $unit->id) selected
                                                                        @endif
                                                                        @endisset
                                                                        value="{{$unit->id}}">{{$unit->unit_name}}</option>
                                                                @endif
                                    ...
                                    <div id="cost" class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number"
                                                   @isset($oldProduct['cost']) value="{{$oldProduct['cost']}}" @endisset
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="price"
                                                   @isset($oldProduct['price']) value="{{$oldProduct['price']}}"
                                                   @endisset
                                    ...
                                    <div id="alert-qty" class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input
                                                @isset($oldProduct['alert_quantity']) value="{{$oldProduct['alert_quantity']}}"
                                                @endisset
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="tax_id" class="form-control selectpicker">
                                                ...
                                                @foreach($lims_tax_list as $tax)
                                                    <option
                                                        @isset($oldProduct['tax_id'])
                                                        @if($oldProduct['tax_id'] == $tax->id) selected @endif
                                                        @endisset
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{trans('VAT Method')}}</strong> </label> <i
                                            ...
                                            <select name="tax_method" class="form-control selectpicker">
                                                <option
                                                    @isset($oldProduct['tax_method'])
                                                    @if($oldProduct['tax_method'] == 1) selected @endif
                                                    @endisset
                                                    value="1">{{trans('file.Exclusive')}}</option>
                                                <option
                                                    @isset($oldProduct['tax_method'])
                                                    @if($oldProduct['tax_method'] == 2) selected @endif
                                                    @endisset
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input
                                                    @isset($oldProduct['product_item_code'])
                                                    value="{{$oldProduct['product_item_code']}}"
                                                    @endisset
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input @isset($oldProduct['warranty']) value="{{$oldProduct['warranty']}}"
                                                   @endisset
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea
                                                ...
                                                @isset($oldProduct['product_details']) value="{{$oldProduct['product_details']}}"
                                                @endisset
                                            </textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12 mt-2" id="diffPrice-option">
                                        <h5><input
                                                @isset($oldProduct['is_diffPrice']) @if($oldProduct['is_diffPrice'] == 1) checked="checked"
                                                @endif
                                                @endisset
                                                name="is_diffPrice" type="checkbox" id="is-diffPrice"
                                                value="1">&nbsp; {{trans('file.This product has different price for different warehouse')}}
                                        </h5>
                                    </div>
                                            ...
                                            <table id="diffPrice-table" class="table table-hover">
                                                ...
                                                @foreach($lims_warehouse_list as $key => $warehouse)
                                                    <tr>
                                                        ...
                                                        <td><input
                                                                @isset($oldProduct['diff_price'][$key]) value="{{$oldProduct['diff_price'][$key]}}"
                                                                @endisset
                                    ...
                                    <div class="col-md-12 mt-3" id="variant-option">
                                        <h5><input
                                                @isset($oldProduct['is_variant'])
                                                    @if($oldProduct['is_variant'] == 1)
                                                        checked="checked"
                                                    @endif
                                                @endisset
                                    ...
                                    <div class="col-md-12" id="variant-section">
                                        ...
                                        <div class="table-responsive ml-2">
                                            <table id="variant-table" class="table table-hover variant-list">
                                                ...
                                                <tbody>
                                                {{--@isset($oldProduct['is_variant'])--}}
                                                    {{--@if(array_key_exists(0,$oldProduct['variant_name']))--}}
                                                        {{--@foreach($oldProduct['variant_name'] as $key => $variant_name)--}}
                                                            {{--<tr>--}}
                                                                {{--<td>{{$key+1}}</td>--}}
                                                                {{--<td>{{$variant_name}}</td>--}}
                                                                {{--<td>{{$oldProduct['item_code'][$key]}}</td>--}}
                                                                {{--<td>{{$oldProduct['additional_price'][$key]}}</td>--}}
                                                            {{--</tr>--}}
                                                        {{--@endforeach--}}
                                                    {{--@endif--}}
                                                {{--@endisset--}}
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <input
                                            @isset($oldProduct['promotion'])
                                            @if($oldProduct['promotion'] == 1)
                                            checked="checked"
                                            @endif
                                            @endisset
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-4" id="promotion_price">
                                                ...
                                                <input
                                                    @isset($oldProduct['promotion_price']) value="{{$oldProduct['promotion_price']}}"
                                                    @endisset
                                            ...
                                            <div class="col-md-4" id="start_date">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input
                                                            @isset($oldProduct['starting_date']) value="{{$oldProduct['starting_date']}}"
                                                            @endisset
                                            ...
                                            <div class="col-md-4" id="last_date">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input
                                                            @isset($oldProduct['last_date']) value="{{$oldProduct['last_date']}}"
                                                            @endisset
        ...
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input id="addCategoryBtn" type="submit" value="{{trans('file.submit')}}" class="btn btn-primary">
                    </div>
                </div>
                </form>
                {{--{{ Form::close() }}--}}
    ...
    <div id="brandModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
        ...
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                <form id="addBrand" action="{{route('brand.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input type="submit" id="addBrandBtn" value="{{trans('file.submit')}}"
                                   class="btn btn-primary">
                        </div>
                    </div>
