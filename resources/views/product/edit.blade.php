                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <label>{{trans('file.product')}} {{trans('Product VAT')}}</strong> </label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <label>{{trans('VAT Method')}}</strong> </label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="product_item_code" class="form-control"
                                                       ...
                                                       value="{{$lims_product_data->product_item_code}}"
            ...
            <div class="modal-content">
                ...
                <form id="cat-form" action="">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input type="submit" id="addCatBtn" value="{{trans('file.submit')}}"
