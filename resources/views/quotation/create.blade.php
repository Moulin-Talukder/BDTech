                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="quotation_no" required class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="customer_id" name="customer_id" required class="selectpicker form-control" data-live-search="true" id="customer-id" data-live-search-style="begins" title="Select customer...">
                                                ...
                                                <option value="{{$customer->id}}">{{$customer->company_name . ' (' . $customer->phone_number . ')'}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row align-items-center">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-check mb-2">
                                                <a href="{{route('products.create')}}" type="button" name="add" id="addRemoveIp" class="btn btn-info" title="Add Product"><i class="fa fa-plus"></i></a>
                                            </div>
                                        </div>
                                    </div>
