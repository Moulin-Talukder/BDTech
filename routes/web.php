...
Route::group(['middleware' => ['auth', 'active']], function() {
	...
	Route::get('products/gencode', 'ProductController@generateCode')->name('product.gencode');
	Route::get('products/search', 'ProductController@search')->name('product.search');
	Route::get('products/saleunit/{id}', 'ProductController@saleUnit')->name('product.unitId');
    ...
    Route::get('service/chalan/{id}', 'ServiceController@chalan')->name('service.chalan');
    ...
    Route::get('services/generatecode','ServiceController@generateCode')->name('services.gencode');
    ...
    Route::get('customer/customer/getCustomer/{id}','CustomerController@getCustomer');
    ...
    Route::get('customer/customer/getDeposit/{id}', 'CustomerController@getDeposit');
	...
	Route::get('sales/chalan/{id}', 'SaleController@chalan')->name('sale.chalan');
	...
	// Route::post('quotations/sendmail', 'QuotationController@sendMail')->name('quotation.sendmail');
	// Route::post('quotations/deletebyselection', 'QuotationController@deleteBySelection');
	Route::get('service_quotations/getservices', 'ServiceQuotationController@getServices')->name('quotation.getservices');
	Route::get('service_quotations/receipt/{id}', 'ServiceQuotationController@receipt')->name('service_quotations.receipt');
	Route::get('service_quotations/services/sum/{id}', 'ServiceQuotationController@serviceSum')->name('service_quotations.services.sum');
	Route::post('service_quotations/services/sale', 'ServiceQuotationController@serviceSale')->name('service.quotation.sale');
	Route::get('service_quotations/services/sale/edit{id}', 'ServiceQuotationController@serviceSaleEdit')->name('service.quotation.sale.edit');
	Route::put('service_quotations/services/sale/update{id}', 'ServiceQuotationController@serviceSaleUpdate')->name('service.quotation.update');
	Route::resource('service_quotations', 'ServiceQuotationController');
	...
	Route::get('expense_categories/gencode', 'ExpenseCategoryController@generateCode')->name('expense.gencode');
	...
	Route::get('employees/employee_inactive/{id}', 'EmployeeController@employeeInactive')->name('employee.inactive');
	Route::get('employees/employee_inactive/{id}', 'EmployeeController@employeeInactive')->name('employee.inactive');
	...
	Route::get('attendance/my_attendance', 'AttendanceController@employeeAttendance')->name('attendance.my_attendance');
	Route::post('attendance/report', 'AttendanceController@dateWiseReportPost')->name('attendance.report');
	Route::get('attendance/report', 'AttendanceController@dateWiseReportGet')->name('attendance.report');
	Route::post('attendance/report/momthly', 'AttendanceController@monthWiseReportPost')->name('attendance.report.momthly');
	Route::get('attendance/report/momthly', 'AttendanceController@monthWiseReportGet')->name('attendance.report.momthly');
	Route::resource('attendance', 'AttendanceController');
	//Leave Route
	Route::get('leave/approve/{id}', 'LeaveController@approveLeave')->name('leave.approve');
	Route::get('leave/cancel/{id}', 'LeaveController@cancelLeave')->name('leave.cancel');
	Route::get('leave/report/pending', 'LeaveController@indexForAdmin')->name('leave.report.pending');
    ...
    Route::resource('priority', 'CustomerPriorityController');
    ...
    //Route::get('getDistrict/{id}', 'EmployeeController@getDistrict')->name('getDistrict');
    //Route::get('getThana/{}', 'EmployeeController@getThana')->name('getThana');
