...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        parse_str($request->product_old_value, $productOld);
        //dd($productOld);
        ...
        request()->session()->put('productModalcategory', $latestCategory->id);
        request()->session()->put('productOld', $productOld);

        if(isset($request->catAdd)){
        ...
        //dd($productModalcategory);
        if (isset($request->returntoproduct) && $request->returntoproduct != null) {

            return redirect(route('products.create'))->with('message', 'Category inserted successfully', compact('latestCategory'));
        } elseif (isset($request->returntopurchase) && $request->returntopurchase != null) {
            return back();
        } else {
    ...
    // //return to add product page
    // public function storeReturnToProduct(Request $request){
