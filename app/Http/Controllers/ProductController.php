...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        $oldProduct = request()->session()->get('productOld');
        //dd($oldProduct);
        request()->session()->forget('productOld');

        $brandsession = request()->session()->get('brandsession');
        ...
        if ($role->hasPermissionTo('products-add')){
            ...
            return view('product.create',compact(
                'lims_product_list', 'lims_brand_list',
                'lims_category_list', 'lims_unit_list', 'lims_tax_list',
                'lims_warehouse_list', 'lims_categories', 'lims_category_all',
                'productModalcategory', 'brandsession', 'oldProduct'));
        }
        else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
    ...
    public function store(Request $request)
    {
        ...
        //$data['item_code'] = $request->product_item_code;
        ...
        if(isset($request->productPop)){
            $data =$lims_product_data['code'].' ('.$lims_product_data['name'].')';
            return $data;
        }
    ...
    public function edit($id)
    {
        ...
        if ($role->hasPermissionTo('products-edit')) {
            ...
            return view('product.edit',compact('lims_product_list', 'lims_brand_list', 'lims_category_list', 'lims_unit_list', 'lims_tax_list', 'lims_product_data', 'lims_product_variant_data', 'lims_warehouse_list', 'productModalcategory', 'brandsession', 'lims_categories', 'lims_category_all'));
        }
        else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
