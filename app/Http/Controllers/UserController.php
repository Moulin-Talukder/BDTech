...
class UserController extends Controller
{
    ...
    public function create()
    {
        ...
        if($role->hasPermissionTo('users-add')){
            ...
            $lims_customer_priority = CustomerPriority::where('is_active', true)->get();
            return view('user.create', compact('lims_role_list', 'lims_biller_list',
                'lims_warehouse_list', 'lims_customer_group_list','lims_customer_priority'));
        }
        else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
