...
class TransferController extends Controller
{
    ...
    public function create()
    {
        ...
        $fromWarehouseSession = request()->session()->get('fromWarehouseSession');
        $toWarehouseSession = request()->session()->get('toWarehouseSession');
        $role = Role::find(Auth::user()->role_id);
        if($role->hasPermissionTo('transfers-add')){
            ...
            return view('transfer.create', compact('lims_warehouse_list', 'fromWarehouseSession', 'toWarehouseSession', 'lims_categories', 'lims_category_all', 'lims_product_list', 'lims_brand_list', 'lims_category_list', 'lims_unit_list', 'lims_tax_list', 'lims_warehouse_list'));
        }
        else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
    ...
    public function edit($id)
    {
        ...
        if($role->hasPermissionTo('transfers-edit')){
            ...
            $lims_unit_list = Unit::where('is_active', true)->get();
            $lims_tax_list = Tax::where('is_active', true)->get();
            return view('transfer.edit', compact('lims_warehouse_list', 'lims_transfer_data', 'lims_product_transfer_data', 'lims_categories', 'lims_category_all', 'lims_product_list', 'lims_brand_list', 'lims_category_list', 'lims_unit_list', 'lims_tax_list'));
        }
        else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
