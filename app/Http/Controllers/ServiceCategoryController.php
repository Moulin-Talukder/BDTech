...
class ServiceCategoryController extends Controller
{
    ...
    {
        parse_str($request->old_value, $serviceOld);
        //dd($serviceOld);
        ...
        $latestCategory = ServiceCategory::latest()->first();
        request()->session()->put('serviceModalcategory', $latestCategory->id);
        request()->session()->put('serviceOldValue', $serviceOld);

        if(isset($request->supplierSerCat)){
            return [
        ...
        if(isset($request->returntoservice) && $request->returntoservice != null){
            ...
            return redirect(route('services.create'))->with('message', 'Category inserted successfully',compact('latestCategory'));
