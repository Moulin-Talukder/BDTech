...
class WarehouseController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (isset($request->fromWarehouse) && $request->fromWarehouse != null) {

            $fromWarehouse = Warehouse::latest()->first();
            request()->session()->put('fromWarehouseSession', $fromWarehouse->id);
            return back();
        } elseif (isset($request->toWarehouse) && $request->toWarehouse != null) {

            $toWarehouse = Warehouse::latest()->first();
            request()->session()->put('toWarehouseSession', $toWarehouse->id);
            return back();
        } else {
