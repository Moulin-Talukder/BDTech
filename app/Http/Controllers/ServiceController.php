...
class ServiceController extends Controller
{
    ...
    {
        $serviceOld = request()->session()->get('serviceOldValue');
        //dd($serviceOld);
        request()->session()->forget('serviceOldValue');
        ...
        return view('service.create', compact('lims_tax_list',
            'service_categories', 'categories', 'all_categories',
            'serviceModalcategory','serviceOld'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if(isset($request->returntoservice) && $request->returntoservice != null){
            return back();
        }
    ...
    public function edit($id)
    {
        ...
        $lims_tax_list = Tax::where('is_active', true)->get();
        $service_categories = ServiceCategory::where('is_active', true)->get();
        return view('service.edit', compact('lims_tax_list', 'service_categories', 'service_list','categories', 'all_categories'));
    }
    ...
    public function serviceSaleCreate()
    {
        ...
        $all_categories = ServiceCategory::where('is_active', true)->get();
        $service_categories = ServiceCategory::where('is_active', true)->get();
        return view('service.service_sale', compact('lims_customer_list', 'lims_tax_list', 'lims_pos_setting_data', 'lims_customer_group_all', 'interests', 'lims_priority_all',  'lims_biller_list', 'services', 'categories', 'all_categories', 'service_categories',   'serviceModalcategory'));
    }
    ...
    public function saleEdit($id)
    {
        ...
        $services = Service::where('is_active', true)->get();
        return view('service.service_sale_edit', compact('lims_customer_list', 'lims_biller_list', 'lims_sale_data', 'lims_tax_list', 'lims_service_sale_data', 'services', 'lims_pos_setting_data', 'lims_customer_group_all', 'interests', 'lims_priority_all', 'categories', 'all_categories', 'service_categories'));
    }
    ...
    public function genInvoice($id)
    {
        ...
        return view('service.invoice', compact('lims_sale_data', 'lims_service_sale_data', 'lims_biller_data', 'lims_customer_data', 'lims_payment_data', 'numberInWords', 'date'));
    }
    public function chalan($id)
    {
        ...
        return view('service.chalan', compact('lims_sale_data', 'lims_service_sale_data', 'lims_biller_data', 'lims_customer_data', 'lims_payment_data', 'numberInWords', 'date'));
    }
