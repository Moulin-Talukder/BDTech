...
class CustomerGroupController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $latestCustomergroup = CustomerGroup::latest()->first();
        //request()->session()->put('customerGroupModal', $latestCustomergroup->id);
        if(isset($request->customerAddGroup)){
            return [
                "id"=>$latestCustomergroup->id,
                "name"=>$latestCustomergroup->name,
            ];
        }
