...
class SupplierController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        request()->session()->put('purchaseModalcategory', $latestSupplier->id);

        if(isset($request->supplierAdd)){
            return [
                "id"=>$latestSupplier->id,
                "name"=>$latestSupplier->name,
            ];
        }

        if(isset($request->returntopurchase) && $request->returntopurchase != null){
