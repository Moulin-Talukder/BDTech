                                ...
                                <div class="form-row align-items-center">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-check mb-2">
                                                <a href="<?php echo e(route('products.create')); ?>" type="button" name="add" id="addRemoveIp" class="btn btn-info" title="Add Product"><i class="fa fa-plus"></i></a>
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bdtech\resources\views/adjustment/create.blade.php ENDPATH**/ ?>