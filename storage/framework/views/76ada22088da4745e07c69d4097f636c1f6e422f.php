        ...
        <table>
            ...
            <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <tr>
                    ...
                    <td style="text-align:center"><?php echo e($service->code); ?></td>
                    <td>
                    ...
                    <td style="text-align:right"><?php echo e(number_format((float)$service->price, 2, '.', '')); ?></td>
            ...
            <tfoot>
            <tr>
                <th class="non_border sm-font" colspan="2" width="70%">Bill Amount in WORD : "<?php echo e(\App\helper\NumberToWord::get($lims_sale_data->grand_total)); ?> "TAKA ONLY</th>
                ...
                <th style="text-align:right;">
                    <p><?php echo e(number_format((float)$lims_sale_data->total_price, 2, '.', '')); ?></p>
...
<?php /**PATH /home/wardan/bdtech.wardan.biz/resources/views/sale/service_invoice.blade.php ENDPATH**/ ?>