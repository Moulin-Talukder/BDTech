                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="italic"><small
                                    style="color:red"><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input
                                            <?php if(isset($employeeOld['employee_name'])): ?> value="<?php echo e($employeeOld['employee_name']); ?>"
                                            <?php endif; ?> type="text" name="employee_name" required class="form-control">
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <strong><?php echo e($errors->first('permanent_district')); ?></strong>
                                    ...
                                    <div class="form-group">
                                        <label><?php echo e(trans('Thana')); ?> *</label>
                                        <select class="form-control selectpicker" data-live-search="true"
            ...
            <div class="modal-content">
                ...
                <form id="department-form">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input type="submit" id="addDepartmentBtn" value="<?php echo e(trans('file.submit')); ?>"
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wardan/bdtech.wardan.biz/resources/views/employee/create.blade.php ENDPATH**/ ?>