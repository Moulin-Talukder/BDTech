                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <?php endif; ?>
                                <li class="divider"></li>
                                <li><button type="button" data-id="<?php echo e($expense->id); ?>" class="open-viewModal btn btn-link"><i class="fa fa-eye"></i> Voucher</button></li>
                  ...
                  <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <select id="expenseCat" name="expense_category_id" class=" form-control" required data-live-search="true" data-live-search-style="begins" >
...
<div id="view-voucher" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                  <h5 id="modal_header" class="modal-title">Voucher</h5>&nbsp;&nbsp;
...
<script type="text/javascript">
    ...
    $(".open-viewModal").on("click",function(){
        ...
        var url = "<?php echo e(route('expenses.show', ':id')); ?>";
        url = url.replace(':id', id);
        $.get(url, function(data) {
            console.log(data);
            $('#reference_no').text(data[0]);
            $('#warehouse').text(data[1]);
            $('#category').text(data[2]);
            $('#amount').text(data[3]);
            $('#user').text(data[4]);
            $('#account_name').text(data[5]);
            $('#notes').text(data[6]);
        });
        $('#view-voucher').modal('show');
        //alert(url);
    });


    $("#print-btn").on("click", function(){
          var divToPrint=document.getElementById('view-voucher');
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wardan/bdtech.wardan.biz/resources/views/expense/index.blade.php ENDPATH**/ ?>