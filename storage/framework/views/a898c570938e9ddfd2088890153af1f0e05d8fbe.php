        ...
        <div class="table-responsive mb-4">
            <table id="account-table" class="table table-hover">
                ...
                <tr> 
                    ...
                    <th><?php echo e(trans('Details')); ?></th>
                ...
                <?php $__currentLoopData = $credit_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$credit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($lims_account_data->name); ?> [<?php echo e($lims_account_data->account_no); ?>

            ]-<?php echo e($credit->payment_reference); ?></td>
                ...
                <?php $__currentLoopData = $service_credit_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$credit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $balance = $balance + $credit->amount; ?>
                    <tr>
                        <td><?php echo e($key); ?></td>
                        <td><?php echo e(date($general_setting->date_format, strtotime($credit->created_at->toDateString()))); ?></td>
                ...
                <?php $__currentLoopData = $recieved_money_transfer_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$recieved_money): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <td><p>Purpose: <?php echo e($recieved_money->purpose); ?></p>
                        <p>Note: <?php echo e($recieved_money->note); ?></p></td>
                ...
                <?php $__currentLoopData = $sent_money_transfer_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$sent_money): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <td><p>Purpose: <?php echo e($sent_money->purpose); ?></p>
                        <p>Note: <?php echo e($sent_money->note); ?></p></td>
                        <td>0.00</td>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wardan/bdtech.wardan.biz/resources/views/account/account_statement.blade.php ENDPATH**/ ?>