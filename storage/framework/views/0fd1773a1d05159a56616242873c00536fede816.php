    ...
    <div class="side-navbar-wrapper">
      ...
      <div class="main-menu">
        <ul id="side-main-menu" class="side-menu list-unstyled">
          ...
          <?php if($service_category_permission_active || $service_delivery_permission_active || $service_index_permission_active || $service_sale_index_permission_active || $print_qrcode_active): ?>
          <li><a href="#service" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-list"></i><span>Service</span><span></a>
            <ul id="service" class="collapse list-unstyled ">
              <?php if($service_category_permission_active): ?>
              <li id="service-category-menu"><a href="<?php echo e(route('categories.index')); ?>">Category</a></li>
              <?php endif; ?>
              <?php if($service_index_permission_active): ?>
              <li id="service-list-menu"><a href="<?php echo e(route('services.index')); ?>">Service List</a></li>
              <?php
              ...
              ?>
              <?php if($service_add_permission_active): ?>
              <li id="service-create-menu"><a href="<?php echo e(route('services.create')); ?>">Add Service</a></li>
              <?php endif; ?>
              <?php endif; ?>
          ...
          <li>
              <a href="#service_reciept" aria-expanded="false" data-toggle="collapse">
                  ...
                  <span>
                      <?php echo e(trans('Service Receipt')); ?>

                  </span>
              </a>
            <ul id="service_reciept" class="collapse list-unstyled ">
              <li id="service_reciept-list-menu"><a href="<?php echo e(route('service_quotations.index')); ?>"><?php echo e(trans('Service Receipt List')); ?></a></li>
              <?php
              ...
              ?>
              <?php if($add_permission_active): ?>
              <li id="service_reciept-create-menu"><a href="<?php echo e(route('service_quotations.create')); ?>"><?php echo e(trans('Add Service Receipt')); ?></a></li>
              <?php endif; ?>
            </ul>
          </li>
          <?php endif; ?>
          ...
          <li class=""><a href="#crm" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-user-group"></i><span>CRM</span></a>
            ...
            <li class="<?php echo e(Request::is('customer.index') ? 'active' : ''); ?>"><a href="<?php echo e(route('customer.index')); ?>"><?php echo e(trans('file.Customer List')); ?></a></li>
            ...
            <li id="supplier-create-menu"><a href="<?php echo e(route('supplier.create')); ?>"><?php echo e(trans('file.Add Supplier')); ?></a></li>
              ...
              <li class=""><a href="#hrm" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-user-group"></i><span>HRM</span></a>
                <ul id="hrm" class="collapse list-unstyled ">
                  ...
                  <li id="monthly-attendance-menu"><a href="<?php echo e(route('attendance.report.momthly')); ?>">Monthly Attendance</a></li>
              ...
              <li class=""><a href="#leave" aria-expanded="false" data-toggle="collapse"><span>My Profile</span></a>
                <ul id="leave" class="collapse list-unstyled ">
                  <li id="attendance-menu"><a href="<?php echo e(route('attendance.my_attendance')); ?>"><?php echo e(trans('My Attendance')); ?></a></li>
                  <li id="attendance-menu"><a href="<?php echo e(route('leave.index')); ?>"><?php echo e(trans('Leaves')); ?></a></li>
                </ul>
              </li>
        ...
        <?php if($reminder_index_permission_active): ?>
        <li><a href="#reminder" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-clock-o"></i><span>Reminder</span></a>
          <ul id="reminder" class="collapse list-unstyled ">
            <li id="reminder-list-menu"><a href="<?php echo e(route('reminder.index')); ?>">Reminder List</a></li>
          </ul>
        </li>
        <?php endif; ?>
        ...
        ?>
        <?php if($comment_index_permission_active): ?>
        <li><a href="#comment" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-comment"></i><span>Comment</span></a>
          <ul id="comment" class="collapse list-unstyled ">
            <li id="comment-list-menu"><a href="<?php echo e(route('comment.index')); ?>">Comment List</a></li>
          </ul>
        </li>
        <?php endif; ?>
        <?php
        ...
        <?php endif; ?>
        <li id="customer-priority-menu"><a href="<?php echo e(route('priority.index')); ?>">Priority</a></li>
      ...
      <div class="container-fluid">
        <div class="navbar-holder d-flex align-items-center justify-content-between">
          ...
          <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
            ...
            ?>
            <?php if($add_permission_active): ?>
            <li class="nav-item"><a class="dropdown-item btn-pos btn-sm" href="<?php echo e(route('sales.create')); ?>"><i class="dripicons-shopping-bag"></i><span> Product Sale</span></a></li>
            <?php endif; ?>
            <li class="nav-item"><a id="btnFullscreen"><i class="dripicons-expand"></i></a></li>
            <?php if(\Auth::user()->role_id <= 2): ?> <li class="nav-item"><a href="<?php echo e(route('cashRegister.index')); ?>" title="<?php echo e(trans('file.Cash Register List')); ?>"><i class="dripicons-archive"></i></a></li>
              <?php endif; ?>
              ...
              $commentNextCount = DB::table('comments')
                ...
                ->count();
              ?>
              <?php if($reminder_permission_active): ?> 
              <li class="nav-item">
                <a href="<?php echo e(route('reminder.index')); ?>" class="btn btn-link"><i class="fa fa-clock-o"></i><span class="badge badge-warning notification-number"><?php echo e($todayCount+$nextCount); ?></span></a>
                <!-- <ul class="dropdown-menu edit-options dropdown-menu-left dropdown-default notifications" user="menu" style="right:20px !important">
                  <li class="reminder">
                    <a href="/reminder" class="btn btn-link"> You have <?php echo e($todayCount + $nextCount); ?> Reminders</a>
                  </li>
              ...
              <li class="nav-item" id="notification-icon">
                ...
                <a href="<?php echo e(route('comment.index')); ?>" class="btn btn-link"><i class="dripicons-bell"></i><span class="badge badge-danger notification-number"><?php echo e($commentTodayCount+$commentNextCount); ?></span></a>
                      ...
                      <div class="modal-body">
                          ...
                          <div class="form-group">
                              ...
                              <div class="input-group">
                                  ...
                                  <div class="input-group-append">
                                      <button id="genbuttonCatExpense" type="button" class="btn btn-default"><?php echo e(trans('file.Generate')); ?></button>
                                  </div>
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              <input type="submit" id="expenseCatAdd" value="<?php echo e(trans('file.submit')); ?>" class="btn btn-primary">
                          </div>
                      </div>
                  </form>
  ...
  <script type="text/javascript">
    ...
    $('#expenseCatAdd').on("click", function (e) {
        ...
        $.ajax({
            ...
            url:"<?php echo e(route('expense_categories.store')); ?>",
...
<?php /**PATH C:\xampp\htdocs\bdtech\resources\views/layout/main.blade.php ENDPATH**/ ?>