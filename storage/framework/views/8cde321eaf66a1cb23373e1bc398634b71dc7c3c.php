        ...
        <div class="navbar-holder d-flex align-items-center justify-content-between">
          ...
          <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
            ...
            <?php if(\Auth::user()->role_id <= 2): ?> <li class="nav-item"><a href="<?php echo e(route('cashRegister.index')); ?>" title="<?php echo e(trans('file.Cash Register List')); ?>"><i class="dripicons-archive"></i></a></li>
              ...
              <li class="nav-item">
                <a rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-item"><i class="fa fa-clock-o"></i><span class="badge badge-warning notification-number"><?php echo e($todayCount+$nextCount); ?></span>
                </a>
...
<?php /**PATH C:\xampp\htdocs\wardan\bdtech\resources\views/layout/main.blade.php ENDPATH**/ ?>