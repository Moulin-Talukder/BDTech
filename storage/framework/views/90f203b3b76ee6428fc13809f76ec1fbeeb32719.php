                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select required id="customer_id" name="customer_id" class=" form-control sel" data-live-search="true"  data-live-search-style="begins" >
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="commission_rate" id="commission_rate" value="<?php echo e($lims_sale_data->commission_rate); ?>" class="form-control" step="any" />
                                            <input type="hidden" name="commission_amount" id="commission_amount" value="<?php echo e($lims_sale_data->commission_amount); ?>" class="form-control" step="any" />
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="order_discount" class="form-control" value="<?php echo e($lims_sale_data->order_discount); ?>" step="any" min="0" />
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="submit" id="addCustomerBtn" value="<?php echo e(trans('file.submit')); ?>" class="btn btn-primary">
                </div>
            </div>
            </form>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <select name="category_id" required class="selectpicker form-control sel" data-live-search="true" data-live-search-style="begins" title="Select Category...">
                                        ...
                                        <option <?php if(isset($productModalcategory)): ?> <?php if($productModalcategory==$category->id): ?> selected
                                            <?php endif; ?>
...
$("ul#sale").siblings('a').attr('aria-expanded', 'true');
    ...
    $('select[name="order_discount_type"]').val($('input[name="order_discount_type_hidden"]').val());
    ...
    function calculateGrandTotal() {
        ...
        var discount_method = $("#order_discount_type option:selected").val();
        ...
        if (discount_method == 2) {
            var discount = (subtotal) * (order_discount / 100)
            var grand_total = (subtotal + order_tax + shipping_cost) - (discount + commission_rate);
        } else {
    ...
    $('input[name="order_discount"]').on("input", function() {
        ...
        if (discount_method == 0) {
            alert('Please select discount method');
        } else {
            calculateGrandTotal();
        }
    });
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bdtech\resources\views/sale/edit.blade.php ENDPATH**/ ?>