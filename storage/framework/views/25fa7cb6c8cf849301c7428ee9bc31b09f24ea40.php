						    ...
						    <table class="table table-bordered permission-table">
                                ...
                                <tr>
						            ...
						            <td class="text-center">
						                <div class="icheckbox_square-blue checked" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                <?php if(in_array("services-index", $all_permission)): ?>
						            ...
						            <td class="text-center">
						                <div class="icheckbox_square-blue checked" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                ...
								                <input type="checkbox" value="1" id="service-sales-index" name="service-sales-index" checked />
								                <?php else: ?>
								                <input type="checkbox" value="1" id="service-sales-index" name="service-sales-index">
								                <?php endif; ?>
								                <label for="service-sales-index"></label>
								            </div>
						            	</div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue checked" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                ...
								                <input type="checkbox" value="1" id="service-sales-add" name="service-sales-add" checked />
								                <?php else: ?>
								                <input type="checkbox" value="1" id="service-sales-add" name="service-sales-add">
								                <?php endif; ?>
								                <label for="service-sales-add"></label>
								            </div>
						            	</div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                ...
								                <input type="checkbox" value="1" id="service-sales-edit" name="service-sales-edit" checked>
								                <?php else: ?>
								                <input type="checkbox" value="1" id="service-sales-edit" name="service-sales-edit">
								                <?php endif; ?>
								                <label for="service-sales-edit"></label>
								            </div>
						            	</div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                ...
								                <input type="checkbox" value="1" id="service-sales-delete" name="service-sales-delete" checked>
								                <?php else: ?>
								                <input type="checkbox" value="1" id="service-sales-delete" name="service-sales-delete">
								                <?php endif; ?>
								                <label for="service-sales-delete"></label>
								            </div>
						            	</div>
						            </td>
						        </tr>
                                ...
                                <tr>
						            ...
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
                                            <?php if(in_array("comments-index", $all_permission)): ?>
								                <input type="checkbox" value="1" id="comments-index" name="comments-index" checked>
                                            <?php else: ?>
								                <input type="checkbox" value="1" id="comments-index" name="comments-index">
                                            <?php endif; ?>
						            ...
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
                                            ...
                                            <?php if(in_array("comments-add", $all_permission)): ?>
								                <input type="checkbox" value="1" id="comments-add" name="comments-add" checked>
                                            <?php else: ?>
								                <input type="checkbox" value="1" id="comments-add" name="comments-add">
                                            <?php endif; ?>
								                <label for="comments-add"></label>
								            </div>
						            	</div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
                                            ...
                                            <?php if(in_array("comments-edit", $all_permission)): ?>
								                <input type="checkbox" value="1" id="comments-edit" name="comments-edit" checked>
                                            <?php else: ?>
								                <input type="checkbox" value="1" id="comments-edit" name="comments-edit">
                                            <?php endif; ?>
								                <label for="comments-edit"></label>
								            </div>
						            	</div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
                                            ...
                                            <?php if(in_array("comments-delete", $all_permission)): ?>
								                <input type="checkbox" value="1" id="comments-delete" name="comments-delete" checked>
                                            <?php else: ?>
								                <input type="checkbox" value="1" id="comments-delete" name="comments-delete">
                                            <?php endif; ?>
								                <label for="comments-delete"></label>
								            </div>
						            	</div>
						            </td>
                                </tr>
						            ...
						            <td class="report-permissions" colspan="5">
						            	<span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	<?php if(in_array("reminder-index", $all_permission)): ?>
							                    	<input type="checkbox" value="1" id="reminder-index" name="reminder-index" checked>
							                    	<?php else: ?>
							                    	<input type="checkbox" value="1" id="reminder-index" name="reminder-index">
							                    	<?php endif; ?>
								                    <label for="reminder-index" class="padding05">Reminder List &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
                                        <span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	<input type="checkbox" value="1" id="reminder-add" name="reminder-add" checked>
							                    	<?php else: ?>
							                    	<input type="checkbox" value="1" id="reminder-add" name="reminder-add">
							                    	<?php endif; ?>
								                    <label for="reminder-add" class="padding05">Reminder Add &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
						                <span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	<input type="checkbox" value="1" id="reminder-edit" name="reminder-edit" checked>
							                    	<?php else: ?>
							                    	<input type="checkbox" value="1" id="reminder-edit" name="reminder-edit">
							                    	<?php endif; ?>
								                    <label for="reminder-edit" class="padding05">Reminder Edit &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
						                <span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	<input type="checkbox" value="1" id="reminder-delete" name="reminder-delete" checked>
							                    	<?php else: ?>
							                    	<input type="checkbox" value="1" id="reminder-delete" name="reminder-delete">
							                    	<?php endif; ?>
								                    <label for="reminder-delete" class="padding05">Reminder Delete &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
						                <span>
						                    <div aria-checked="false" aria-disabled="false">
						                    	<div class="checkbox">
							                    	<?php if(in_array("reminder-alert", $all_permission)): ?>
							                    	<input type="checkbox" value="1" id="reminder-alert" name="reminder-alert" checked>
							                    	<?php else: ?>
							                    	<input type="checkbox" value="1" id="reminder-alert" name="reminder-alert">
							                    	<?php endif; ?>
								                    <label for="reminder-alert" class="padding05">Reminder Alert &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
						            </td>
						        ...
						        <tr>
						            ...
						            <td class="report-permissions" colspan="5">
                                        ...
                                        <span>
								            <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	<?php if(in_array("service_category", $all_permission)): ?>
							                    	<input type="checkbox" value="1" id="service_category" name="service_category" checked>
							                    	<?php else: ?>
							                    	<input type="checkbox" value="1" id="service_category" name="service_category">
							                    	<?php endif; ?>
								                    <label for="service_category" class="padding05">Service Category &nbsp;&nbsp;</label>
								                </div>
								            </div>
						            	</span>
                                        ...
                                        <span>
						            		<div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	<input type="checkbox" value="1" id="service_delivery" name="service_delivery" checked>
							                    	<?php else: ?>
							                    	<input type="checkbox" value="1" id="service_delivery" name="service_delivery">
							                    	<?php endif; ?>
								                    <label for="service_delivery" class="padding05">Service Delivery &nbsp;&nbsp;</label>
								                </div>
								            </div>
						            	</span>
                                        ...
                                        <span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	<?php if(in_array("print_qrcode", $all_permission)): ?>
							                    	<input type="checkbox" value="1" id="print_qrcode" name="print_qrcode" checked>
							                    	<?php else: ?>
							                    	<input type="checkbox" value="1" id="print_qrcode" name="print_qrcode">
							                    	<?php endif; ?>
								                    <label for="print_qrcode" class="padding05">Print QRcode &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
						                <span>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wardan/bdtech.wardan.biz/resources/views/role/permission.blade.php ENDPATH**/ ?>