...
<div class="alert alert-danger alert-dismissible text-center">
    <button type="button" id="close" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button><?php echo e(session()->get('not_permitted')); ?></div>
<?php endif; ?>
<section class="forms">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <select id="supplier" name="supplier_id" class=" sel form-control" data-live-search="true" data-live-search-style="begins" >
                                                    ...
                                                    <option
                                                        ...
                                                        value="<?php echo e($supplier->id); ?>"><?php echo e($supplier->name .' ('. $supplier->company_name .')'); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group mt-4">
                            <input type="submit" id="supplierAddButton" value="<?php echo e(trans('file.submit')); ?>" class="btn btn-primary">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" name="product_item_code" class="form-control" id="item_code" aria-describedby="item_code" required>
                                <div class="input-group-append">
...
<script type="text/javascript">
    ...
    function populate_category(unitID){
        var url = "<?php echo e(route('product.unitId', ":id")); ?>";
...
<script>
    ...
    $('#supplierAddButton').on("click", function (e) {
        e.preventDefault();
            $.ajax({
                type:'POST',
                url:"<?php echo e(route('supplier.store')); ?>",
                data: $("#supplier-add-form").serialize(),
                success:function(response){
                    console.log(response);
                    //location.href = '../purchases/create';
                    ...
                    $("#supplier").val(response.id).change();
                    $('.close').click();
                    $('#supplier-add-form').trigger("reset");
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mouloseu/my.moulin.live/bdtech/resources/views/purchase/create.blade.php ENDPATH**/ ?>