                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" value="<?php echo e($lims_product_data->name); ?>" required
                                                   class="form-control">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="code" id="code"
                                                       value="<?php echo e($lims_product_data->code); ?>" class="form-control"
                                                       required>
                                                <div class="input-group-append">
                                                    <button id="genbuttonCode" type="button"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select id="brand_id" name="brand_id" class=" form-control sel"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <label><?php echo e(trans('file.product')); ?> <?php echo e(trans('Product VAT')); ?></strong> </label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <label><?php echo e(trans('VAT Method')); ?></strong> </label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="product_item_code" class="form-control"
                                                       id="product_item_code"
                                                       value="<?php echo e($lims_product_data->product_item_code); ?>"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="product_details" class="form-control"
                                                      rows="5"><?php echo e(str_replace('@', '"', $lims_product_data->product_details)); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12 mt-2" id="diffPrice-option">
                                        <?php if($lims_product_data->is_diffPrice): ?>
                                            <h5><input name="is_diffPrice" type="checkbox" id="is-diffPrice" value="1"
                                                       checked>&nbsp; <?php echo e(trans('file.This product has different price for different warehouse')); ?>

                                            </h5>
                                        <?php else: ?>
                                            <h5><input name="is_diffPrice" type="checkbox" id="is-diffPrice" value="1">&nbsp; <?php echo e(trans('file.This product has different price for different warehouse')); ?>
                                    ...
                                    <div class="col-md-12 mt-3" id="variant-option">
                                        ...
                                        <?php else: ?>
                                            <h5><input name="is_variant" type="checkbox" id="is-variant" value="1">&nbsp; <?php echo e(trans('file.This product has variant')); ?>
            ...
            <div class="modal-content">
                ...
                <form id="cat-form" action="">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input type="submit" id="addCatBtn" value="<?php echo e(trans('file.submit')); ?>"
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wardan/bdtech.wardan.biz/resources/views/product/edit.blade.php ENDPATH**/ ?>