        ...
        <table id="money-transfer-table" class="table">
            <thead>
                <tr>
                    ...
                    <th><?php echo e(trans('Purpose')); ?></th>
            ...
            <tbody>
                ...
                <tr data-id="<?php echo e($money_transfer->id); ?>">
                    ...
                    <td><?php echo e($money_transfer->fromAccount->name); ?>-<?php echo e($money_transfer->reference_no); ?>

                    <?php echo e($money_transfer->note); ?>

                    </td>
                    <td><?php echo e($money_transfer->fromAccount->name); ?></td>
                    <td><?php echo e($money_transfer->toAccount->name); ?></td>
                    <td><?php echo e($money_transfer->purpose); ?></td>
                    <td><?php echo e($money_transfer->note); ?></td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        <label> <?php echo e(trans('Purpose')); ?> *</label>
                        <select class="form-control selectpicker" name="purpose" data-live-search="true" data-live-search-style="begins" required>
...
<script type="text/javascript">
    ...
    function datatable_sum(dt_selector, is_calling_first) {
        if (dt_selector.rows('.selected').any() && is_calling_first) {
            ...
            $(dt_selector.column(7).footer()).html(dt_selector.cells(rows, 5, {
                page: 'current'
            }).data().sum().toFixed(2));
        } else {
            $(dt_selector.column(7).footer()).html(dt_selector.cells(rows, 5, {
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wardan/bdtech.wardan.biz/resources/views/money_transfer/index.blade.php ENDPATH**/ ?>